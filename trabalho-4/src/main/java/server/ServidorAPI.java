...
import resource.FerramentaResource;
import resource.FilaResource;
import resource.MuralResource;
import resource.PixelResource;
...
public class ServidorAPI {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Inicie o consumidor em outro terminal com: java -cp target/classes worker.WorkerFila");
    }
}
