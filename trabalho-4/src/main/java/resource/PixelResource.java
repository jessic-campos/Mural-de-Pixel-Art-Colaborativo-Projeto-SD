...
public class PixelResource {
    ...
    public PixelResource(PixelArtService service) { this.service = service; }
    ...
    public void handlePixel(HttpExchange exchange) throws IOException {
        try {
            ...
            if (metodo.equalsIgnoreCase("POST")) {
                ...
                String resposta = service.pintarPixel(x, y, cor);
                System.out.println("\n[API/PRODUTOR] Evento PINTAR_PIXEL enfileirado: (" + x + ", " + y + ") cor " + cor);
                ...
                String resposta = service.apagarPixel(x, y);
                System.out.println("\n[API/PRODUTOR] Evento APAGAR_PIXEL enfileirado: (" + x + ", " + y + ")");
                System.out.println("[API/PRODUTOR] " + service.statusFilaJson());
                HttpResponder.enviarJson(exchange, 200, resposta);
            } else {
