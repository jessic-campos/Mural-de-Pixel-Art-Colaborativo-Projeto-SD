...
public class EventoFila {
    ...
    private final int x, y, x1, y1, x2, y2, largura, altura;
    private final String cor, dono, criadoEm;
    ...
    public static EventoFila fromJson(String json) {
        ...
        return new EventoFila(
            m.getOrDefault("tipo", ""),
            parseInt(m.get("x")), parseInt(m.get("y")),
            parseInt(m.get("x1")), parseInt(m.get("y1")),
            parseInt(m.get("x2")), parseInt(m.get("y2")),
            parseInt(m.get("largura")), parseInt(m.get("altura")),
            m.getOrDefault("cor", ""), m.getOrDefault("dono", ""),
